...
metadata_filepath = 'tools/ft/release-notes/metadata.yml'
...
faq_nav_filepath = 'tools/mkdocs/mkdocs_release-notes.yml'
...
content = re.sub(r'site_name:.*', 'site_name: AI SDK Release Notes', content)
