...
metadata_filepath = 'tools/ft/manual/metadata.yml'
...
faq_nav_filepath = 'tools/mkdocs/mkdocs_manual.yml'
...
content = re.sub(r'site_name:.*', 'site_name: AI SDK Operation Manual', content)
